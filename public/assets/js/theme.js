  ...
  var i = "body",
    ...
    t = {
      ...
      stickyNavbar: function (t, a) {
        if ((500, l((t = ".navbar-sticky")).length)) {
          ...
          l(o).on("scroll", function () {
            500 < l(this).scrollTop()
              ? (l(t).addClass("navbar-stuck"),
                l(t).hasClass("navbar-floating") || l(i).css("padding-top", e))
              : (l(t).removeClass("navbar-stuck"), l(i).css("padding-top", 0));
          });
        }
      },
      ...
      isotopeFilter: function (e, i) {
        (i = ".nav-tabs"),
          l((e = ".filter-grid")).length &&
            l(i).on("click", "a", function (t) {
              t.preventDefault(),
      ...
      scrollBackTop: function (t, a, e) {
        if ((600, 1200, l((t = ".scroll-to-top-btn")).length)) {
          ...
          l(o).on("scroll", function () {
            l(this).scrollTop() > i
              ? l(t).addClass("visible")
              : l(t).removeClass("visible");
          }),
      ...
      creditCard: function (t) {
        l((t = ".interactive-credit-card")).length &&
          l(t).card({
            form: t,
      ...
      filterList: function (t, i) {
        l(t).each(function () {
          ...
          a.keyup(function () {
            ...
            ".list-group-item" === i
              ? l(i).each(function () {
                  0 == l(this).text().toLowerCase().indexOf(t.toLowerCase())
                    ? l(this).show()
                    : l(this).hide();
                })
              : l(i).each(function () {
                  0 == l(this).text().toLowerCase().indexOf(t.toLowerCase())
                    ? l(this).parents("[data-filter-item]").show()
                    : l(this).parents("[data-filter-item]").hide();
                });
          }),
            e.on("click", function (t) {
              ...
              ".list-group-item" === i
                ? "all" !== a
                  ? (l(i).hide(), l("[data-filter-item=" + a + "]").show())
                  : l(i).show()
                : "all" !== a
                ? (l(i).parents("[data-filter-item]").hide(),
                  l("[data-filter-item=" + a + "]").show())
                : l(i).parents("[data-filter-item]").show();
            });
        });
      },
      productGallery: function (t) {
        l((t = ".product-carousel")).length &&
          l(t).owlCarousel({
            items: 1,
            loop: !1,
            dots: !1,
      ...
      linkedCarousels: function (t, a) {
        l((t = ".post-cards-carousel")).length &&
          l(t).on("change.owl.carousel", function (t) {
      ...
      teamHover: function (t) {
        l((t = ".no-touchevents .team-card-style-1")).on(
          "mouseover",
          function () {
        ...
        l(".range-slider").each(function () {
          ...
          noUiSlider.create(a[0], {
            ...
            a[0].noUiSlider.on("update", function (t, a) {
              var e = t[a];
              a
                ? (i.valueMax.text(Math.round(e)),
                  i.valueMaxInput.val(Math.round(e)))
                : (i.valueMin.text(Math.round(e)),
                  i.valueMinInput.val(Math.round(e)));
            });
        });
      },
      parallax: function () {
